%% Step 6 - Strain Models 
% Generate Strain GEMs from PanGEM (both standalone format and PanGEM
% format)
...
%% Paths
FileNames.PanGEM_path = 'data_copy/models/Pro_PanGEM.mat';
FileNames.L2Assembly_path = 'data_copy/assemblies/Assembly_L2_20200830.mat';
FileNames.Destination_L3 = 'data_copy/assemblies/Assembly_L3_20200830.mat';
FileNames.Destination_StrMod = 'data_copy/models/StrMod.mat';
FileNames.Destination_StrMod_Standalone = 'data_copy/models/StrMod_Standalone.mat';
...
for a = 1:nStrains
    ...
    outputFile = strcat('data_copy/models/strains/',targStr,'.mat');
...
load('data_copy/models/StrMod.mat');
